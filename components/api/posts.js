...
export function createPost(id, isPersonal, inputValue, locationTpye, volume, vibrate) {
    return new Promise((resolve, reject) => {
        resolve(_createPost(id, isPersonal, inputValue, locationTpye, volume, vibrate));
    });
}
...
// Simulated server-side code
function _createPost(id, isPersonal, inputValue, locationTpye, volume, vibrate) {
